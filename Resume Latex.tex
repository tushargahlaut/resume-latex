...
\begin{itemize}
    ...
    \item {\normalfont Developed \textbf{Microservices and REST APIs with Node.js, Typescript} and deployed them on \textbf{Red Hat Openshift} and ensured Continuous Integration and Continuous Deployment using \textbf{Tekton} Pipelines.}
    ...
    \item {\normalfont Followed \textbf{Test Driven Development} approach and used \textbf{Jest, Mocha, Chai etc} libraries to implement Test Suites to ensure high code coverage.}
    \item {\normalfont Implemented \textbf{Microsoft Azure AD authentication} for IndiGo's internal applications, also worked with \textbf{Azure Blob Storage, Azure OpenAI Services} as per the business requirements.}
\end{itemize}
