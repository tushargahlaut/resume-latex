...
\begin{itemize}
    ...
    \item {\normalfont Implemented \textbf{Microsoft Azure AD Authentication} for IndiGo's internal applications, also worked on \textbf{Azure Blob storage} and \textbf{SAS tokens} to manage document files.}
\end{itemize}
