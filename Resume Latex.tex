...
\begin{itemize}
    ...
    \item {\normalfont Used \textbf{Microsoft Azure AI Services} like \textbf{Semantic Search, Document Intelligence etc} and \textbf{Azure Cosmos DB} for building 6Eskai's Knowledge Base.}
